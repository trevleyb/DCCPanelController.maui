...
namespace DCCClients.Discovery {
    ...
    public static class DiscoverServices {
        ...
        public static async Task<IResult<List<DiscoveredService>>> SearchForJmriServicesAsync() => await SearchForServicesAsync("_http._tcp","jmri");
        public static async Task<IResult<List<DiscoveredService>>> SearchForWiThrottleServicesAsync() => await SearchForServicesAsync("_withrottle._tcp");
