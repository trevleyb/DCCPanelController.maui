...
public class ServiceInfo {
    public ServiceInfo(string name, string address, int port) : this(name, new WiThrottleClientSettings(address, port)) { }

    public ServiceInfo(string name, WiThrottleClientSettings wiThrottleClientSettings) {
        ...
        WiThrottleClientSettings = wiThrottleClientSettings;
    }

    public string Name { get; set; }
    public WiThrottleClientSettings WiThrottleClientSettings { get; set; }
