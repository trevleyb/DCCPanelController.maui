...
public class JmriClientIntegrationTests {
    ...
    public void OneTimeSetUp() {
        var jmriUrl = "http://localhost:12080"; // Environment.GetEnvironmentVariable("JMRI_SERVER_URL");
        if (string.IsNullOrEmpty(jmriUrl)) {
            Assert.Ignore("JMRI_SERVER_URL environment variable not set. Skipping integration tests.");
        }
