...
public class WiThrottleClientIntegrationTests
{
    ...
    public void OneTimeSetUp()
    {
        ...
        var wiThrottleAddress = Environment.GetEnvironmentVariable("WITHROTTLE_SERVER_ADDRESS");
        var wiThrottlePortStr = Environment.GetEnvironmentVariable("WITHROTTLE_SERVER_PORT");
