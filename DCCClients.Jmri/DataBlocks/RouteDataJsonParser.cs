...
namespace DccClients.Jmri.DataBlocks; // Root structure that contains the turnout data

public static class RouteParser {
    public static JmriRouteData? ParseRouteData(string jsonString) {
        ...
        return JsonSerializer.Deserialize<JmriRouteData>(cleanedJson, options);
    }
}