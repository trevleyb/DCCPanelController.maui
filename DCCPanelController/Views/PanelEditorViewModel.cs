...
using DCCPanelController.Views.Properties;
using DCCPanelController.Views.Properties.PanelProperties;
using DCCPanelController.Views.Properties.TileProperties;
using DCCPanelController.Views.TileSelectors;
using Microsoft.Extensions.Logging;
using Syncfusion.Maui.Toolkit.BottomSheet;
using Syncfusion.Maui.Toolkit.Popup;
using PanelPropertyViewModel = DCCPanelController.Views.Properties.PanelProperties.PanelPropertyViewModel;
...
public partial class PanelEditorViewModel : ObservableObject {
    ...
    public List<Entity> SelectedEntities => Enumerable.Select<ITile, Entity>(SelectedTiles, x => x.Entity).ToList();
    ...
    public void CheckIfPanelChanged() {
        ArgumentNullException.ThrowIfNull(_original, "Original Panel should never be undefined.");
        ArgumentNullException.ThrowIfNull((object?)Panel, "Panel should never be undefined.");
