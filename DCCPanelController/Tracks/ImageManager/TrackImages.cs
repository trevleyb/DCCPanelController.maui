...
//     public Dictionary<(CompassPoints points, StyleTrackSubType trackState), TrackImage> ImageRotations { get; } = new();
...
//     }
//
//     public void Add(int trackRotation, StyleTrackSubType trackState, string imageSource, int rotation) {
//         try {
...
//     }
//
//     public TrackImage Get(int trackRotation, StyleTrackSubType trackState) {
//         return Get(Compass.ConvertFromDegress(trackRotation), trackState);
//     }
//
//     public TrackImage Get(CompassPoints compassPoint, StyleTrackSubType trackState) {
//         var attempts = 0;
//         while (attempts < 8) {
