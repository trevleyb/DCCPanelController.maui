...
public static class Compass {
    ...
    public static CompassPoints ToCompass(int rotation) => ConvertFromDegress(rotation);
    public static int ToRotation(this CompassPoints compassPoint) => Degrees(compassPoint);
