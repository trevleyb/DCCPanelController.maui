...
public partial class RectangleEntity : DrawingEntity, IDrawingEntity {
    ...
    [JsonIgnore] public override string EntityInformation =>
        "The Rectangle **square** allows you to draw squares and rectangles with a border and and internal color. You can set the *opacity* and show it underneath other tracks and objects.";
