...
public class GridSelectionEventArgs : EventArgs {
    public GridSelectionEventArgs(int startCol, int startRow) => (StartCol, StartRow, EndCol, EndRow) = (startCol, startRow, startCol, startRow);

    public GridSelectionEventArgs(int startCol, int startRow, int endCol, int endRow) => (StartCol, StartRow, EndCol, EndRow) = (startCol, startRow, endCol, endRow);
    public int StartCol { get; }
    public int StartRow { get; }
