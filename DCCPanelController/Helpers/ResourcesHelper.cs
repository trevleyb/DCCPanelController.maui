...
public static class ResourcesHelper {
    private static IEnumerable<string> GetImageResourceNames(Assembly assembly, string resourceFolder) {
        ...
        var imageResourceNames = resourceNames.Where(name => name.StartsWith(resourceFolder, StringComparison.OrdinalIgnoreCase)).Where(name => name.EndsWith(".png", StringComparison.OrdinalIgnoreCase) || name.EndsWith(".jpg", StringComparison.OrdinalIgnoreCase)).ToList();
    ...
    public static IEnumerable<ImageSource> GetSymbolImages() {
        ...
        var imageNames = GetImageResourceNames(assembly, resourceFolder);
